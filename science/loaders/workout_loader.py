    ...
    for athlete in athlete_list:
        ...
        for row, index in df[df['name'] == athlete].iterrows():
            try:
                ...
                row_dist_meters_joules = row_distance_calc(row_500_time, row_dist_meters)
                row_calories_joules = row_calories_calc(row_calories)
